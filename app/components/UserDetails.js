...
function UserDetails(user){
  return(
    ...
    {!!user.info.name && <li className="list-group-item">Score: {user.info.name}</li>}
    ...
    {!!user.info.blog && <li className="list-group-item">Blog: <a href={user.info.company}> {user.info.blog}</a></li>}
    </div>
  )
}
